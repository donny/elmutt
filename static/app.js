...
var _donny$ideaboard$Card$Model = F4(
	function (a, b, c, d) {
		return {counter: a, text: b, isHidden: c, isEditingText: d};
	});
var _donny$ideaboard$Card$model = A4(_donny$ideaboard$Card$Model, 0, 'Untitled', false, false);
var _donny$ideaboard$Card$RequestHide = {ctor: 'RequestHide'};
var _donny$ideaboard$Card$RequestUpvote = {ctor: 'RequestUpvote'};
var _donny$ideaboard$Card$RequestRename = function (a) {
	return {ctor: 'RequestRename', _0: a};
};
var _donny$ideaboard$Card$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			...
			case 'FinishEditingText':
				return {
					...
					_1: _elm_lang$core$Maybe$Just(
						_donny$ideaboard$Card$RequestRename(model.text))
				};
			case 'TextChanged':
				return {
					ctor: '_Tuple2',
			...
			case 'Upvote':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Maybe$Just(_donny$ideaboard$Card$RequestUpvote)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Maybe$Just(_donny$ideaboard$Card$RequestHide)
				};
		}
	});
var _donny$ideaboard$Card$Hide = {ctor: 'Hide'};
var _donny$ideaboard$Card$Upvote = {ctor: 'Upvote'};
var _donny$ideaboard$Card$TextChanged = function (a) {
	return {ctor: 'TextChanged', _0: a};
};
var _donny$ideaboard$Card$FinishEditingText = {ctor: 'FinishEditingText'};
var _donny$ideaboard$Card$StartEditingText = {ctor: 'StartEditingText'};
var _donny$ideaboard$Card$view = function (model) {
	return model.isHidden ? A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('text-xs-center')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('btn-group dropup btn-group-sm')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Events$onClick(_donny$ideaboard$Card$Upvote)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Attributes$class('fa fa-thumbs-o-up')
													]),
												_elm_lang$core$Native_List.fromArray(
													[]))
											])),
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('btn btn-secondary'),
												_elm_lang$html$Html_Events$onClick(_donny$ideaboard$Card$FinishEditingText)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												A2(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Attributes$class('fa fa-check-square-o')
													]),
												_elm_lang$core$Native_List.fromArray(
													[]))
											])) : A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('btn btn-secondary'),
												_elm_lang$html$Html_Events$onClick(_donny$ideaboard$Card$StartEditingText)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												A2(
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$html$Html_Events$onClick(_donny$ideaboard$Card$Hide)
													]),
												_elm_lang$core$Native_List.fromArray(
													[
...
var _donny$ideaboard$CardList$model = {
	text: 'Untitled',
	isEditingText: false,
	cards: _elm_lang$core$Native_List.fromArray(
		[])
};
var _donny$ideaboard$CardList$Model = F3(
	function (a, b, c) {
		return {text: a, isEditingText: b, cards: c};
	});
var _donny$ideaboard$CardList$RequestHideCard = function (a) {
	return {ctor: 'RequestHideCard', _0: a};
};
var _donny$ideaboard$CardList$RequestUpvoteCard = function (a) {
	return {ctor: 'RequestUpvoteCard', _0: a};
};
var _donny$ideaboard$CardList$RequestRenameCard = F2(
	function (a, b) {
		return {ctor: 'RequestRenameCard', _0: a, _1: b};
	});
var _donny$ideaboard$CardList$RequestNewCard = {ctor: 'RequestNewCard'};
var _donny$ideaboard$CardList$RequestRename = function (a) {
	return {ctor: 'RequestRename', _0: a};
};
		...
		switch (_p0.ctor) {
			...
			case 'FinishEditingText':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{isEditingText: false}),
					_1: _elm_lang$core$Maybe$Just(
						_donny$ideaboard$CardList$RequestRename(model.text))
				};
			case 'TextChanged':
				return {
					ctor: '_Tuple2',
			...
			case 'AskNewCard':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Maybe$Just(_donny$ideaboard$CardList$RequestNewCard)
				};
			case 'InsertingCard':
				var newModel = _donny$ideaboard$Card$model;
				var newCard = {
					ctor: '_Tuple2',
					_0: _p0._0,
			...
			case 'RenamingCard':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							cards: A2(_elm_lang$core$List$map, updateCard, model.cards)
						}),
					_1: _elm_lang$core$Maybe$Nothing
				};
			case 'UpvotingCard':
				var updateCard = function (_p5) {
					var _p6 = _p5;
					var _p8 = _p6._1;
					var _p7 = _p6._0;
					return _elm_lang$core$Native_Utils.eq(_p7, _p0._0) ? {
						ctor: '_Tuple2',
						_0: _p7,
						_1: _elm_lang$core$Native_Utils.update(
							_p8,
			...
			case 'HidingCard':
				var updateCard = function (_p9) {
					var _p10 = _p9;
					var _p12 = _p10._1;
					var _p11 = _p10._0;
					return _elm_lang$core$Native_Utils.eq(_p11, _p0._0) ? {
						ctor: '_Tuple2',
						_0: _p11,
						_1: _elm_lang$core$Native_Utils.update(
							_p12,
			...
			default:
				var _p20 = _p0._0;
				var updateCard = function (_p13) {
					var _p14 = _p13;
					var _p17 = _p14._1;
					var _p16 = _p14._0;
					if (_elm_lang$core$Native_Utils.eq(_p16, _p20)) {
						var _p15 = A2(_donny$ideaboard$Card$update, _p0._1, _p17);
						var newCardModel = _p15._0;
						var dispatch = _p15._1;
						return {
							ctor: '_Tuple2',
							_0: {ctor: '_Tuple2', _0: _p16, _1: newCardModel},
							_1: dispatch
						};
					} else {
						return {
				...
				var _p18 = _elm_lang$core$List$unzip(
					A2(_elm_lang$core$List$map, updateCard, model.cards));
				var cards = _p18._0;
				var dispatches = _p18._1;
					...
					switch (_p19._0.ctor) {
						case 'RequestRename':
							return {
								...
								_0: newModel,
								_1: _elm_lang$core$Maybe$Just(
									A2(_donny$ideaboard$CardList$RequestRenameCard, _p20, _p19._0._0))
							};
						case 'RequestUpvote':
							return {
								ctor: '_Tuple2',
								_0: newModel,
								_1: _elm_lang$core$Maybe$Just(
									_donny$ideaboard$CardList$RequestUpvoteCard(_p20))
							};
						default:
							return {
								ctor: '_Tuple2',
								_0: newModel,
								_1: _elm_lang$core$Maybe$Just(
									_donny$ideaboard$CardList$RequestHideCard(_p20))
							};
					}
				}
		}
	});
var _donny$ideaboard$CardList$Modify = F2(
	function (a, b) {
		return {ctor: 'Modify', _0: a, _1: b};
	});
var _donny$ideaboard$CardList$HidingCard = function (a) {
	return {ctor: 'HidingCard', _0: a};
};
var _donny$ideaboard$CardList$UpvotingCard = F2(
	function (a, b) {
		return {ctor: 'UpvotingCard', _0: a, _1: b};
	});
var _donny$ideaboard$CardList$RenamingCard = F2(
	function (a, b) {
		return {ctor: 'RenamingCard', _0: a, _1: b};
	});
var _donny$ideaboard$CardList$InsertingCard = F2(
	function (a, b) {
		return {ctor: 'InsertingCard', _0: a, _1: b};
	});
var _donny$ideaboard$CardList$AskNewCard = {ctor: 'AskNewCard'};
var _donny$ideaboard$CardList$TextChanged = function (a) {
	return {ctor: 'TextChanged', _0: a};
};
var _donny$ideaboard$CardList$FinishEditingText = {ctor: 'FinishEditingText'};
var _donny$ideaboard$CardList$StartEditingText = {ctor: 'StartEditingText'};
var _donny$ideaboard$CardList$view = function (model) {
	var cardView = function (_p21) {
		var _p22 = _p21;
		return A2(
			_elm_lang$html$Html_App$map,
			_donny$ideaboard$CardList$Modify(_p22._0),
			_donny$ideaboard$Card$view(_p22._1));
	};
	var cardViews = A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		A2(_elm_lang$core$List$map, cardView, model.cards));
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('btn-group pull-right')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								model.isEditingText ? A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('btn btn-secondary'),
										_elm_lang$html$Html_Events$onClick(_donny$ideaboard$CardList$FinishEditingText)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('btn btn-secondary'),
										_elm_lang$html$Html_Events$onClick(_donny$ideaboard$CardList$StartEditingText)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('btn btn-secondary'),
										_elm_lang$html$Html_Events$onClick(_donny$ideaboard$CardList$AskNewCard)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
...
var _donny$ideaboard$App$Model = F4(
	function (a, b, c, d) {
		return {backend: a, lists: b, isProcessing: c, isConnected: d};
	});
var _donny$ideaboard$App$NetworkResponseDidReceive = function (a) {
	return {ctor: 'NetworkResponseDidReceive', _0: a};
};
var _donny$ideaboard$App$subscriptions = function (model) {
	return A2(
		_elm_lang$websocket$WebSocket$listen,
		A2(_elm_lang$core$Basics_ops['++'], model.backend, '/receive'),
		_donny$ideaboard$App$NetworkResponseDidReceive);
};
var _donny$ideaboard$App$SendNetworkRequest = function (a) {
	return {ctor: 'SendNetworkRequest', _0: a};
};
var _donny$ideaboard$App$Modify = F2(
	function (a, b) {
		return {ctor: 'Modify', _0: a, _1: b};
	});
var _donny$ideaboard$App$HideCard = F2(
	function (a, b) {
		return {ctor: 'HideCard', _0: a, _1: b};
	});
var _donny$ideaboard$App$UpvoteCard = F3(
	function (a, b, c) {
		return {ctor: 'UpvoteCard', _0: a, _1: b, _2: c};
	});
var _donny$ideaboard$App$RenameCard = F3(
	function (a, b, c) {
		return {ctor: 'RenameCard', _0: a, _1: b, _2: c};
	});
var _donny$ideaboard$App$InsertCard = F3(
	function (a, b, c) {
		return {ctor: 'InsertCard', _0: a, _1: b, _2: c};
	});
var _donny$ideaboard$App$RenameList = F2(
	function (a, b) {
		return {ctor: 'RenameList', _0: a, _1: b};
	});
var _donny$ideaboard$App$InsertList = F2(
	function (a, b) {
		return {ctor: 'InsertList', _0: a, _1: b};
	});
var _donny$ideaboard$App$Refresh = function (a) {
	return {ctor: 'Refresh', _0: a};
};
var _donny$ideaboard$App$NoOp = {ctor: 'NoOp'};
var _donny$ideaboard$App$REQ_HIDECARD = F2(
	function (a, b) {
		return {ctor: 'REQ_HIDECARD', _0: a, _1: b};
	});
var _donny$ideaboard$App$REQ_UPVOTECARD = F2(
	function (a, b) {
		return {ctor: 'REQ_UPVOTECARD', _0: a, _1: b};
	});
var _donny$ideaboard$App$REQ_RENAMECARD = F3(
	function (a, b, c) {
		return {ctor: 'REQ_RENAMECARD', _0: a, _1: b, _2: c};
	});
var _donny$ideaboard$App$REQ_NEWCARD = function (a) {
	return {ctor: 'REQ_NEWCARD', _0: a};
};
var _donny$ideaboard$App$REQ_RENAMELIST = F2(
	function (a, b) {
		return {ctor: 'REQ_RENAMELIST', _0: a, _1: b};
	});
var _donny$ideaboard$App$REQ_NEWLIST = {ctor: 'REQ_NEWLIST'};
...
var _donny$ideaboard$App$view = function (model) {
	...
	var cardListViews = A2(
		...
		A2(_elm_lang$core$List$map, cardListView, model.lists));
	return model.isConnected ? A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('navbar navbar-light')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_donny$ideaboard$App$SendNetworkRequest(_donny$ideaboard$App$REQ_REFRESH))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('btn btn-secondary'),
								_elm_lang$html$Html_Events$onClick(
								_donny$ideaboard$App$SendNetworkRequest(_donny$ideaboard$App$REQ_NEWLIST))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('New List')
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								model.isProcessing ? A2(
								_elm_lang$html$Html$span,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('label label-pill label-warning')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Processing...')
									])) : A2(
								_elm_lang$html$Html$span,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('label label-pill label-default')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Connected')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('display-3')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Hi there!')
									])),
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('You have been invited to participate in a discussion...')
									])),
								A2(
								_elm_lang$html$Html$hr,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('m-y-2')
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('If it has started already, please tap'),
										A2(
										...
										_elm_lang$html$Html$text('later to load the discussion.')
									])),
								A2(
								_elm_lang$html$Html$button,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('btn btn-secondary'),
										_elm_lang$html$Html_Events$onClick(
										_donny$ideaboard$App$SendNetworkRequest(_donny$ideaboard$App$REQ_CONNECT))
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Get started')
									]))
							]))
					]))
			]));
};
var _donny$ideaboard$App$RESP_HIDECARD = F2(
	function (a, b) {
		return {ctor: 'RESP_HIDECARD', _0: a, _1: b};
	});
var _donny$ideaboard$App$RESP_UPVOTECARD = F3(
	function (a, b, c) {
		return {ctor: 'RESP_UPVOTECARD', _0: a, _1: b, _2: c};
	});
var _donny$ideaboard$App$RESP_RENAMECARD = F3(
	function (a, b, c) {
		return {ctor: 'RESP_RENAMECARD', _0: a, _1: b, _2: c};
	});
var _donny$ideaboard$App$RESP_NEWCARD = F3(
	function (a, b, c) {
		return {ctor: 'RESP_NEWCARD', _0: a, _1: b, _2: c};
	});
var _donny$ideaboard$App$RESP_RENAMELIST = F2(
	function (a, b) {
		return {ctor: 'RESP_RENAMELIST', _0: a, _1: b};
	});
var _donny$ideaboard$App$RESP_NEWLIST = F2(
	function (a, b) {
		return {ctor: 'RESP_NEWLIST', _0: a, _1: b};
	});
var _donny$ideaboard$App$RESP_REFRESH = function (a) {
	return {ctor: 'RESP_REFRESH', _0: a};
};
	...
	if (_p8.ctor === 'Err') {
		...
		switch (_p9) {
			case 'RESP_REFRESH':
				...
				return A2(
					_donny$ideaboard$App$handleDecodedNetworkResponse,
					A2(
						_elm_lang$core$Json_Decode$decodeString,
						A2(
							_elm_lang$core$Json_Decode_ops[':='],
						...
						message),
					function (newList) {
						return _donny$ideaboard$App$RESP_REFRESH(newList);
					});
			case 'RESP_NEWLIST':
				...
				return A2(
					_donny$ideaboard$App$handleDecodedNetworkResponse,
					A2(_elm_lang$core$Json_Decode$decodeString, parsedCardList, message),
					function (_p10) {
						var _p11 = _p10;
						return A2(_donny$ideaboard$App$RESP_NEWLIST, _p11._0, _p11._1);
					});
			case 'RESP_RENAMELIST':
				...
				return A2(
					...
					function (_p12) {
						var _p13 = _p12;
						return A2(_donny$ideaboard$App$RESP_RENAMELIST, _p13._0, _p13._1);
					});
			case 'RESP_NEWCARD':
				var parsedCard = A4(
					_elm_lang$core$Json_Decode$object3,
				...
				return A2(
					_donny$ideaboard$App$handleDecodedNetworkResponse,
					A2(_elm_lang$core$Json_Decode$decodeString, parsedCard, message),
					function (_p14) {
						var _p15 = _p14;
						return A3(_donny$ideaboard$App$RESP_NEWCARD, _p15._0, _p15._1, _p15._2);
					});
			case 'RESP_RENAMECARD':
				...
				return A2(
					...
					function (_p16) {
						var _p17 = _p16;
						return A3(_donny$ideaboard$App$RESP_RENAMECARD, _p17._0, _p17._1, _p17._2);
					});
			case 'RESP_UPVOTECARD':
				...
				return A2(
					...
					function (_p18) {
						var _p19 = _p18;
						return A3(_donny$ideaboard$App$RESP_UPVOTECARD, _p19._0, _p19._1, _p19._2);
					});
			case 'RESP_HIDECARD':
				var parsedCard = A3(
					_elm_lang$core$Json_Decode$object2,
				...
				return A2(
					...
					function (_p20) {
						var _p21 = _p20;
						return A2(_donny$ideaboard$App$RESP_HIDECARD, _p21._0, _p21._1);
					});
			default:
				return _donny$ideaboard$App$RESP_ERROR;
		}
...
var _donny$ideaboard$App$update = F2(
	function (msg, model) {
		...
		switch (_p22.ctor) {
			...
			case 'Refresh':
				var updateCard = function (_p23) {
					...
					return {
						...
						_1: _elm_lang$core$Native_Utils.update(
							newCard,
							{text: _p24._1, counter: _p24._2})
					};
				};
				var updateCardList = function (_p25) {
					var _p26 = _p25;
					...
					return {
						...
						_1: _elm_lang$core$Native_Utils.update(
							...
							{
								text: _p26._1,
								cards: A2(_elm_lang$core$List$map, updateCard, _p26._2)
							})
					};
				};
				var lists = A2(_elm_lang$core$List$map, updateCardList, _p22._0);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					function (item) {
						return _elm_lang$core$Basics$fst(
							A2(
								...
								A2(_donny$ideaboard$CardList$InsertingCard, _p22._1, _p22._2),
								item));
					});
				return {
					ctor: '_Tuple2',
				...
				var newLists = A3(
					...
					function (item) {
						return _elm_lang$core$Basics$fst(
							A2(
								_donny$ideaboard$CardList$update,
								A2(_donny$ideaboard$CardList$RenamingCard, _p22._1, _p22._2),
								item));
					});
				return {
					ctor: '_Tuple2',
				...
				var newLists = A3(
					...
					function (item) {
						return _elm_lang$core$Basics$fst(
							A2(
								_donny$ideaboard$CardList$update,
								A2(_donny$ideaboard$CardList$UpvotingCard, _p22._1, _p22._2),
								item));
					});
				return {
					ctor: '_Tuple2',
				...
				var newLists = A3(
					...
					function (item) {
						return _elm_lang$core$Basics$fst(
							A2(
								_donny$ideaboard$CardList$update,
								_donny$ideaboard$CardList$HidingCard(_p22._1),
								item));
					});
				return {
					ctor: '_Tuple2',
			...
			case 'Modify':
				var _p34 = _p22._0;
				var updateCardList = function (_p27) {
					var _p28 = _p27;
					var _p31 = _p28._1;
					var _p30 = _p28._0;
					if (_elm_lang$core$Native_Utils.eq(_p30, _p34)) {
						var _p29 = A2(_donny$ideaboard$CardList$update, _p22._1, _p31);
						var newListModel = _p29._0;
						var dispatch = _p29._1;
						return {
							ctor: '_Tuple2',
							_0: {ctor: '_Tuple2', _0: _p30, _1: newListModel},
							_1: dispatch
						};
					} else {
						return {
							ctor: '_Tuple2',
							_0: {ctor: '_Tuple2', _0: _p30, _1: _p31},
							_1: _elm_lang$core$Maybe$Nothing
						};
					}
				};
					...
					switch (_p33._0.ctor) {
						case 'RequestRename':
							return A2(
								...
								A2(_donny$ideaboard$App$REQ_RENAMELIST, _p34, _p33._0._0),
								newModel);
						case 'RequestNewCard':
							return A2(
								_donny$ideaboard$App$networkRequestHandler,
								_donny$ideaboard$App$REQ_NEWCARD(_p34),
								newModel);
						case 'RequestRenameCard':
							return A2(
								_donny$ideaboard$App$networkRequestHandler,
								A3(_donny$ideaboard$App$REQ_RENAMECARD, _p34, _p33._0._0, _p33._0._1),
								newModel);
						case 'RequestUpvoteCard':
							return A2(
								_donny$ideaboard$App$networkRequestHandler,
								A2(_donny$ideaboard$App$REQ_UPVOTECARD, _p34, _p33._0._0),
								newModel);
						default:
							return A2(
								_donny$ideaboard$App$networkRequestHandler,
								A2(_donny$ideaboard$App$REQ_HIDECARD, _p34, _p33._0._0),
								newModel);
					}
				}
			case 'SendNetworkRequest':
				return A2(_donny$ideaboard$App$networkRequestHandler, _p22._0, model);
			default:
				return A2(
					_donny$ideaboard$App$networkResponseHandler,
					_donny$ideaboard$App$decodeNetworkResponse(_p22._0),
					model);
		}
	});
	...
	function (resp, model) {
		...
		switch (_p35.ctor) {
			...
			case 'RESP_REFRESH':
				return A2(
					handleNetResponse,
					_donny$ideaboard$App$Refresh(_p35._0),
					model);
			case 'RESP_NEWLIST':
				return A2(
					handleNetResponse,
					A2(_donny$ideaboard$App$InsertList, _p35._0, _p35._1),
					model);
			case 'RESP_RENAMELIST':
				return A2(
					handleNetResponse,
					A2(_donny$ideaboard$App$RenameList, _p35._0, _p35._1),
					model);
			case 'RESP_NEWCARD':
				return A2(
					handleNetResponse,
					A3(_donny$ideaboard$App$InsertCard, _p35._0, _p35._1, _p35._2),
					model);
			case 'RESP_RENAMECARD':
				return A2(
					handleNetResponse,
					A3(_donny$ideaboard$App$RenameCard, _p35._0, _p35._1, _p35._2),
					model);
			case 'RESP_UPVOTECARD':
				return A2(
					handleNetResponse,
					A3(_donny$ideaboard$App$UpvoteCard, _p35._0, _p35._1, _p35._2),
					model);
			default:
				return A2(
					handleNetResponse,
					A2(_donny$ideaboard$App$HideCard, _p35._0, _p35._1),
					model);
		}
	});
var _donny$ideaboard$App$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{init: _donny$ideaboard$App$init, update: _donny$ideaboard$App$update, subscriptions: _donny$ideaboard$App$subscriptions, view: _donny$ideaboard$App$view}),
	flags: _elm_lang$core$Json_Decode$string
};

var Elm = {};
Elm['App'] = Elm['App'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['App'], 'App', typeof _donny$ideaboard$App$main === 'undefined' ? null : _donny$ideaboard$App$main);
Elm['Card'] = Elm['Card'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Card'], 'Card', typeof _donny$ideaboard$Card$main === 'undefined' ? null : _donny$ideaboard$Card$main);
Elm['CardList'] = Elm['CardList'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['CardList'], 'CardList', typeof _donny$ideaboard$CardList$main === 'undefined' ? null : _donny$ideaboard$CardList$main);
